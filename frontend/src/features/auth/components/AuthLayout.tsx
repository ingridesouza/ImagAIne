...
export const AuthLayout = ({ title, subtitle, children, footer }: AuthLayoutProps) => (
  <section className="auth-layout auth-theme">
    <div className="auth-layout__glow auth-layout__glow--primary" aria-hidden />
    <div className="auth-layout__glow auth-layout__glow--secondary" aria-hidden />
